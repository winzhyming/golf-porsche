  ...
  <!-- <div id="index-view" style="background: url(/static/images/2020/dt2020.png) bottom center norepeat;"> -->
    <div class="body-index pr" style="padding-bottom: 39vmin;">
      ...
      <section class="bi-btns">
        <ul>
          <li>
            <router-link :to="{'name': 'huwai.acts'}" class="btn-index" style="color: #fff; border-color: #fff;">活动详情</router-link>
          </li>
          <li>
            <router-link :to="{'name': 'huwai.appoints'}" class="btn-index" style="color: #fff; border-color: #fff;">活动预约</router-link>
          </li>
          <li>
            <router-link :to="{'name': 'huwai.mine'}" class="btn-index" style="color: #fff; border-color: #fff;">我的行程</router-link>
          </li>
          <li><a href="javascript:;" @click="goOtherMini()" class="btn-index" style="color: #fff; border-color: #fff;">影像集锦</a></li>
        </ul>
      </section>
    </div>
