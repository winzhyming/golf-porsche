  ...
  <div id="index-view">
    <div class="body-index pr">
      <section class="bi-tit fen-b">
        ...
        <img class="img-word" src="https://d.devnow.cn/golf2020/images/landing-title.png" alt="2020 保时捷高尔夫巡回赛总决赛 Porsche Golf Cup China Final 2020">
      </section>
      <section class="bi-btns">
        <ul>
          <li>
            <h1>总决赛选手专用入口</h1>
            <router-link :to="{'name': 'player'}" class="btn-index">决赛选手</router-link>
          </li>
          <li>
            <h1>总决赛嘉宾专用入口</h1>
            <router-link :to="{'name': 'guest'}" class="btn-index">决赛嘉宾</router-link>
          </li>
          <li>
            <h1>全体住客通用入口</h1>
