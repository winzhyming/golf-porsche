<template>
  ...
  <div class="ei-main">
    <div class="yuyue2019" style="padding-bottom: 20vmin;">
      <div class="desc">
        <p style="text-indent: 0;">万宁是海南冲浪者的故乡， 中国的冲浪基地。当地知名的南岛东岸冲浪俱乐部就毗邻我们下榻的石梅湾威斯汀。 </p>
        <p style="text-indent: 0;">无论您是冲浪健将， 还是新手小白， 冲浪俱乐部都欢迎大家来体验披波逐浪的乐趣。</p>
        <p style="text-indent: 0;">与此同时，我们也邀请上乘坐万宁最豪华的游艇，纵览美丽的石梅湾；在专业人士的指导下，您可选择参与垂钓或浮潜，并享用美酒美食。</p>
        <p style="text-indent: 0;">还等什么，赶快报名吧！</p>
        <br>
        <br>
        ...
        <br>
        <p style="text-indent: 0;">*温馨提示：请携带好长袖长裤速干服饰。</p>
