      ...
      <article class="ef-art fen" style="padding-bottom: 39vmin;">
        ...
        <section class="clearfix">
          ...
          <span class="fr text-right">
            ...
            <br />注：
            <br />
            <br />当选手一洞成绩达到上述规定最大杆数时，必须停止该洞击球，前往下一洞，并以该洞的最大杆数作为该洞的成绩。
            <br />当选手一洞成绩到达最大杆数限制且没有完成该洞时，则不参与总杆奖项评选。
          </span>
        </section>
        <h2>6. 恶劣天气及暂停比赛</h2>
        <section class="clearfix">
          ...
          <span class="fr text-right">
            ...
            <br />
            <br />
            <strong>在两洞的比赛之间</strong>
            <br />参赛选手须立即停止比赛，在裁判员指示恢复比赛之前他们不得恢复比赛。
            <br />
            <br />
            <strong>在一洞的打球过程</strong>
            <br />参赛选手可以完成该洞后中止比赛，也可以立即中止。在组委会指示恢复比赛之前不得自行恢复比赛。
          </span>
        </section>
        <section class="clearfix">
        ...
        <section class="clearfix">
          <span class="fl lable-left">6.3</span>
          <span class="fr text-right">
        ...
        <section class="clearfix">
          ...
          <span class="fr text-right">
            <strong>最佳团队奖</strong>
            <br />· 如得分相同，则比较差点低的选手，采取后 9 洞总杆（10 – 18 号洞）成绩决定胜负，杆数低着列前；
            <br />· 如仍然相同，采取最后一洞（18 号洞）成绩逐洞倒计数的方式决定名次，杆数少者名次列前；
            <br />· 若仍相同，则采取抽签方式决定。
          </span>
        </section>
        <section class="clearfix">
          ...
          <span class="fr text-right">
            <strong>总杆奖</strong>
            <br />· 完成 18 洞总杆杆数少者名次列前，如成绩相同，采取后 9 洞总杆（10 – 18 号洞）成绩决定胜负，杆数低着列前；
            <br />· 如仍然相同，采取最后一洞（18 号洞）成绩逐洞倒计数的方式决定名次，杆数少者名次列前；
            <br />· 若仍相同，则采取抽签方式决定。
          </span>
        </section>
        <section class="clearfix">
          <span class="fl lable-left">8.3</span>
          <span class="fr text-right">
            <strong>净杆 Stableford 奖</strong>
            <br />· 得分高者名次列前；如成绩相同，差点低者获胜（新新贝利亚计算出的差点）；
            <br />· 如差点相同，采取后 9 洞总杆（10 – 18 号洞）成绩决定胜负，杆数低着列前；
            <br />· 如仍然相同，采取最后一洞（18 号洞）成绩逐洞倒计数的方式决定名次，杆数少者名次列前；
            <br />· 若仍相同，则采取抽签方式决定。
          </span>
        </section>
