    ...
    <div class="es-data">
      ...
      <section class="event-schedule fen">
        ...
        <ul>
          ...
          <li class="clearfix">
            <span class="fl lable-left ellipsis">12:00</span>
            <span class="fr text-right">班车出发</span>
          </li>
          <li class="clearfix li-tit">
            <span class="fl lable-left" style="width: 100%;">酒店 – 鉴湖蓝湾高尔夫球场</span>
          </li>
          <li class="clearfix">
          ...
          <li class="clearfix li-tit">
            <span class="fl lable-left" style="width: 100%;">亚特兰蒂斯水上世界 – 酒店</span>
          </li>
          <li class="clearfix">
      ...
      <section class="event-schedule fen">
        ...
        <ul>
          ...
          <li class="clearfix">
            <span class="fl lable-left ellipsis">06:00 - 19:30</span>
            <span class="fr text-right">根据实际班机情况安排车辆接机</span>
          </li>
        </ul>
      </section>
