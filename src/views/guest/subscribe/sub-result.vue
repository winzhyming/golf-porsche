    ...
    <div class="ef-main">
      <article class="ef-art pc-art mct-art">
        <div class="result-tips form-result">
          <!-- <strong v-if="type === '1'">恭喜您已完成亚特兰蒂斯水世界的预约。</strong>
          <strong v-if="type === '2'">恭喜您已完成呀诺达雨林文化旅游区的预约。</strong>
          <strong v-if="type === '3'">恭喜您已完成威士忌品鉴的预约。</strong>
          <strong v-if="type === '4'">恭喜您已完成威士忌品鉴的预约。</strong> -->
          <strong>尊敬的保时捷车主俱乐部会员<br>恭喜您已完成 12 月 5 日活动的预约</strong>
          <br /><br />
          <p class="table">
            <span class="table-cell" style="width: 5.2em; vertical-align: top;">活动项目：</span>
            <span class="table-cell" v-if="type === '1'">三亚角游艇海钓</span>
            <span class="table-cell" v-if="type === '2'">亚特兰蒂斯水族馆&CDF免税店</span>
            <span class="table-cell" v-if="type === '3'">-呀诺达雨林文化旅游区</span>
            <span class="table-cell" v-if="type === '4'">亚特兰蒂斯水世界</span>
          </p>
          <p class="table">
            <span class="table-cell" style="width: 5.2em; vertical-align: top;">活动日期：</span>
            <span class="table-cell">2020 年 12 月 5 日</span>
          </p>
          ...
          <p class="tips-bot">
            ...
            <b style="font-weight: 600;" v-if="type === '1'">* 请带好身份证件以便登记。</b>
            <b style="font-weight: 600;" v-if="type === '3'">* 请随身携带好个人的身份证件以便入园登记。</b>
            <b style="font-weight: 600;" v-if="type === '4'">* 请带好泳衣等装备及个人的身份证件以便入园登记。</b>
* 如现场有任何问题请联系活动热线：<br>
131-6100-5513
          </p><br />
        </div>
...
// WEBPACK FOOTER //
// src/views/guest/subscribe/sub-result.vue